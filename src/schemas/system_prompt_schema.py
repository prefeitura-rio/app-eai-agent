...
class SystemPromptUpdateRequest(BaseModel):
    ...
    metadata: Optional[Dict[str, Any]] = Field(None, description="Metadados adicionais para armazenar com o prompt")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "metadata": {"author": "admin", "reason": "Melhoria na resposta de emergência"}
            }
        }
...
class SystemPromptUpdateResponse(BaseModel):
    ...
    prompt_id: Optional[str] = Field(None, description="ID do prompt criado no banco de dados")
...
class SystemPromptGetResponse(BaseModel):
    ...
    created_at: Optional[datetime] = Field(None, description="Data de criação do prompt")
...
class SystemPromptHistoryItem(BaseModel):
    ...
    created_at: str = Field(..., description="Data de criação formatada como string ISO")
    updated_at: str = Field(..., description="Data de atualização formatada como string ISO")
