...
from src.api.v1.unified_delete import router as unified_delete_router
from src.api.v1.rmi import router as rmi_router

router = APIRouter(prefix="/v1")
router.include_router(auth_router)
router.include_router(eai_gateway_router)
router.include_router(rmi_router)
...
router.include_router(unified_delete_router)
