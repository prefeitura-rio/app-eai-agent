...
async def test_tool_response():
    ...
    logger.info("🔧 Testando resposta após execução de ferramentas...")
    ...
    try:
        ...
        logger.info("  📝 Teste 1: Salvando informações do usuário...")
        ...
        logger.info("  📝 Teste 2: Buscando informações do usuário...")
        ...
        logger.info("  📝 Teste 3: Buscando preferências...")
        ...
        logger.info("  📝 Teste 4: Buscando restrições...")
        ...
        logger.info("  📝 Teste 5: Salvando nova informação...")
        ...
        logger.info("  📝 Teste 6: Buscando todas as informações...")
        response6 = await chatbot_service.process_message(
            user_id=user_id,
            thread_id=thread_id,
            message="Quais são todas as minhas informações?",
        )
        logger.info(f"    🤖 Resposta 6: {response6.message[:100]}...")
        logger.info(f"    🔧 Ferramentas usadas: {response6.tools_called}")

        # Teste 7: Buscar informações profissionais (get_memory_tool)
        logger.info("  📝 Teste 7: Buscando informações profissionais...")
        response7 = await chatbot_service.process_message(
            user_id=user_id,
            thread_id=thread_id,
            message="O que você sabe sobre mim como profissional?",
        )
        logger.info(f"    🤖 Resposta 7: {response7.message[:100]}...")
        logger.info(f"    🔧 Ferramentas usadas: {response7.tools_called}")

        # Teste 8: Buscar tecnologias (get_memory_tool)
        logger.info("  📝 Teste 8: Buscando tecnologias...")
        response8 = await chatbot_service.process_message(
            user_id=user_id,
            thread_id=thread_id,
            message="Quais tecnologias eu uso?",
        )
        logger.info(f"    🤖 Resposta 8: {response8.message[:100]}...")
        logger.info(f"    🔧 Ferramentas usadas: {response8.tools_called}")

        # Teste 9: Buscar restrições novamente (get_memory_tool)
        logger.info("  📝 Teste 9: Buscando restrições novamente...")
        response9 = await chatbot_service.process_message(
            user_id=user_id,
            thread_id=thread_id,
            message="Lembre-se da minha alergia.",
        )
        logger.info(f"    🤖 Resposta 9: {response9.message[:100]}...")
        logger.info(f"    🔧 Ferramentas usadas: {response9.tools_called}")

        # Teste 10: Contexto da conversa (sem ferramentas)
        logger.info("  📝 Teste 10: Usando contexto da conversa...")
        response10 = await chatbot_service.process_message(
            user_id=user_id,
            thread_id=thread_id,
            message="Qual foi a primeira coisa que eu disse sobre mim nesta conversa?",
        )
        logger.info(f"    🤖 Resposta 10: {response10.message[:100]}...")
        logger.info(f"    🔧 Ferramentas usadas: {response10.tools_called}")
